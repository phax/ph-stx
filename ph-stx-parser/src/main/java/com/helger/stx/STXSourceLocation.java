 ...
 */
@Immutable
public class STXSourceLocation implements Serializable
{
  private final STXSourceArea m_aFirstTokenArea;
  private final STXSourceArea m_aLastTokenArea;
   ...
   */
  public STXSourceLocation (@Nullable final STXSourceArea aFirstTokenArea, @Nullable final STXSourceArea aLastTokenArea)
  {
   ...
   */
  @Nullable
  public STXSourceArea getFirstTokenArea ()
  {
   ...
   */
  @Nullable
  public STXSourceArea getLastTokenArea ()
  {
