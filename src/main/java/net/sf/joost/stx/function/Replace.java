 ...
 * substring of the first parameter that matches the given second parameter 
 * with an occurrence of the third parameter string. The optional fourth
 * parameter influences the matching as in the {@link Matches} function.
 * 
...
final public class Replace implements Instance
{
   ...
   /** @return 4 */
   public int getMaxParCount() { return 4; }

   /** @return "replace" */
   public String getName() { return FunctionFactory.FNSP + "replace"; }
      ...
      throws SAXException, EvalException
   {
      ...
      if (args.left.left.type == Tree.LIST) { // four parameters
