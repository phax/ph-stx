...
public class JRegularExpression implements RegularExpression {
     ...
     * @throws EvalException if the syntax of the regular expression or flags is incorrect
     */
...
//    public JRegularExpression(CharSequence regex, boolean isXPath, int flagBits) throws XPathException {
    public JRegularExpression(CharSequence regex, boolean isXPath, int flagBits) throws EvalException {
        this.flagBits = flagBits;
        try {
            String j = System.getProperty("java.version");
            if (j.startsWith("1.4")) {
...
//    }
     ...
     * @throws EvalException if the replacement string is invalid
     */
