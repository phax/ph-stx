...
public class Whitespace
{
   ...
   /**
    * The values NONE, IGNORABLE, and ALL identify which kinds of whitespace
    * text node should be stripped when building a source tree
    */
   ...
   private static boolean[] C0WHITE = { false, false, false, false, false,
    ...
    * collapseWhitespace, but is cheaper, for use by data types that do not
