/*
 * $Id: LeTree.java,v 1.1 2004/09/29 05:59:51 obecker Exp $
 * 
...
/**
 * Objects of LeTree represent compariosn nodes (less or equal, "&lt;=") in
 * the syntax tree of a pattern or an STXPath expression.
 * @version $Revision: 1.1 $ $Date: 2004/09/29 05:59:51 $
 * @author Oliver Becker
 */
final public class LeTree extends Tree
{
   public LeTree(Tree left, Tree right)
   {
      super(LE, left, right);
   }
