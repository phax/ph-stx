/*
 * $Id: DivTree.java,v 1.1 2004/09/29 05:59:51 obecker Exp $
 * 
...
/**
 * Objects of DivTree represent arithmetic div nodes in the syntax tree of
 * a pattern or an STXPath expression.
 * @version $Revision: 1.1 $ $Date: 2004/09/29 05:59:51 $
 * @author Oliver Becker
 */
final public class DivTree extends Tree
{
   public DivTree(Tree left, Tree right)
   {
