  ...
  public final net.sf.joost.grammar.cup.Symbol CUP$ExprParser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ExprParser$act_num)
		...
		Tree e2 = (Tree)((net.sf.joost.grammar.cup.Symbol) CUP$ExprParser$stack.peek()).value;
		...
		Tree t = (Tree)((net.sf.joost.grammar.cup.Symbol) CUP$ExprParser$stack.peek()).value;
		 RESULT = t; 
		...
		Tree a = (Tree)((net.sf.joost.grammar.cup.Symbol) CUP$ExprParser$stack.peek()).value;
		 a.left = n; 
         RESULT = a; 
		...
		int nleft = ((net.sf.joost.grammar.cup.Symbol)CUP$ExprParser$stack.peek()).left;
		int nright = ((net.sf.joost.grammar.cup.Symbol)CUP$ExprParser$stack.peek()).right;
		Tree n = (Tree)((net.sf.joost.grammar.cup.Symbol) CUP$ExprParser$stack.peek()).value;
		 RESULT = n; 
		...
		Tree k = (Tree)((net.sf.joost.grammar.cup.Symbol) CUP$ExprParser$stack.peek()).value;
		 RESULT = k; 
              CUP$ExprParser$result = parser.getSymbolFactory().newSymbol("AccessorStep",10, ((net.sf.joost.grammar.cup.Symbol)CUP$ExprParser$stack.peek()), ((net.sf.joost.grammar.cup.Symbol)CUP$ExprParser$stack.peek()), RESULT);
            }
          return CUP$ExprParser$result;
		...
		Tree t2 = (Tree)((net.sf.joost.grammar.cup.Symbol) CUP$ExprParser$stack.peek()).value;
