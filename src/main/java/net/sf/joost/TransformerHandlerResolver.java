...
public interface TransformerHandlerResolver
{
    ...
    * @param errorListener the optional ErrorListener configured for Joost
   ...
   TransformerHandler resolve(String method, String href, String base,
                              ...
                              ErrorListener errorListener, Hashtable params)
      throws SAXException;
    ...
    * Each one must return <code>true</code> when checked against
