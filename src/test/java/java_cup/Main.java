...
public class Main
{
   ...
   */
  public static void main (final String argv[]) throws internal_error, java.io.IOException, java.lang.Exception
  {
            ...
            if (argv[i].equals ("-symbols"))
            {
              ...
              if (argv[i].equals ("-nonterms"))
              {
                ...
                if (argv[i].equals ("-expect"))
                {
                  ...
                  if (argv[i].equals ("-compact_red"))
                    opt_compact_red = true;
                  else
                    if (argv[i].equals ("-nosummary"))
                      no_summary = true;
                    else
                      if (argv[i].equals ("-nowarn"))
                        emit.nowarn = true;
                      else
                        if (argv[i].equals ("-dump_states"))
                          opt_dump_states = true;
                        else
                          if (argv[i].equals ("-dump_tables"))
                            opt_dump_tables = true;
                          else
                            if (argv[i].equals ("-progress"))
                              print_progress = true;
                            else
                              if (argv[i].equals ("-dump_grammar"))
                                opt_dump_grammar = true;
                              else
                                if (argv[i].equals ("-dump"))
                                  opt_dump_states = opt_dump_tables = opt_dump_grammar = true;
                                else
                                  if (argv[i].equals ("-time"))
                                    opt_show_timing = true;
                                  else
                                    if (argv[i].equals ("-debug"))
                                      opt_do_debug = true;
                                    else
                                      if (argv[i].equals ("-debugsymbols"))
                                      ...
                                      /* frankf 6/18/96 */
                                        ...
                                        if (argv[i].equals ("-nopositions"))
                                          ...
                                          if (argv[i].equals ("-locations"))
                                            locations = true;
                                          else
                                            if (argv[i].equals ("-xmlactions"))
                                              xmlactions = true;
                                            else
                                              if (argv[i].equals ("-genericlabels"))
                                                genericlabels = true;
                                              /* CSA 12/21/97 */
                                              else
                                                ...
                                                /* CSA 23-Jul-1999 */
                                                  ...
                                                  /* CSA 23-Jul-1999 */
                                                    ...
                                                    /*
                                                     * TUM changes; suggested by
                                                     * Henning Niss 20050628
                                                     */
                                                    else
                                                      if (argv[i].equals ("-typearg"))
                                                      {
                                                        if (++i >= len ||
                                                            argv[i].startsWith ("-") ||
                                                            argv[i].endsWith (".cup"))
  ...
  protected static void emit_summary (final boolean output_produced)
  {
    ...
    System.err.println ("  " +
                        ErrorManager.getManager ().getErrorCount () +
                        " error" +
                        plural (ErrorManager.getManager ().getErrorCount ()) +
                        " and " +
