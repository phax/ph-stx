...
public class lr_item_core
{
   ...
   */
  public lr_item_core (final production prod, final int pos) throws internal_error
  {
      ...
      else
      {
        ...
        if (part == null)
          ...
          if (part.is_action ())
            ...
            if (((symbol_part) part).the_symbol () != null && ((symbol_part) part).the_symbol ().name () != null)
