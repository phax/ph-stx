...
public interface TrAXConstants
{
   ...
   */
  public final static String IDENTITY_TRANSFORM = "<?xml version='1.0'?>" +
   ...
   * @see javax.xml.transform.TransformerFactory#setAttribute
   */
  public static String KEY_OUTPUT_URI_RESOLVER = "http://joost.sf.net/attributes/output-uri-resolver";
   ...
   * @see javax.xml.transform.TransformerFactory#setAttribute
   */
  public static String KEY_XSLT_FACTORY = "http://joost.sf.net/attributes/xslt-factory";
   ...
   * @see javax.xml.transform.TransformerFactory#setAttribute
   */
  public final static String DEBUG_FEATURE = "http://joost.sf.net/attributes/debug-feature";

  /**
   * Key for the Joost message emitter property (must be the class name or an
   * instance of an STXEmitter)
   * {@link net.sf.joost.trax.TransformerFactoryImpl#msgEmitter}
   *
   * @see javax.xml.transform.TransformerFactory#setAttribute
   */
  public final static String MESSAGE_EMITTER_CLASS = "http://joost.sf.net/attributes/messageEmitterClass";

  /**
   * Key for a Joost property that determines whether calls to Java extension
   * functions are allowed. Its property value must be a Boolean.
   *
   * @see javax.xml.transform.TransformerFactory#setAttribute
   */
  public final static String ALLOW_EXTERNAL_FUNCTIONS = "http://joost.sf.net/attributes/allow-external-functions";
   ...
   * {@link Result#PI_ENABLE_OUTPUT_ESCAPING}) will be interpreted or not. Its
   * property value must be a String, either "yes" or "no"
   *
