 ...
 */
/*
 * $Id: Whitespace.java,v 1.1 2007/06/04 19:57:35 obecker Exp $
 *
...
public class Whitespace
{
  ...
  /**
   * The values PRESERVE, REPLACE, and COLLAPSE represent the three options for
   * whitespace normalization. They are deliberately chosen in ascending
   * strength order; given a number of whitespace facets, only the strongest
  ...
  /**
   * The values NONE, IGNORABLE, and ALL identify which kinds of whitespace text
   * node should be stripped when building a source tree
   */
  ...
  public static CharSequence applyWhitespaceNormalization (final int action, final CharSequence value)
  {
    switch (action)
    {
      case PRESERVE:
  ...
  public static CharSequence removeAllWhitespace (final CharSequence value)
  {
  ...
  public static CharSequence removeLeadingWhitespace (final CharSequence value)
  {
    int start = -1;
  ...
  public static boolean containsWhitespace (final CharSequence value)
  {
    final int len = value.length ();
    for (int i = 0; i < len;)
    {
  ...
  public static final boolean isWhite (final CharSequence content)
  {
    final int len = content.length ();
    for (int i = 0; i < len;)
    {
      // all valid XML 1.0 whitespace characters, and only whitespace
      // characters, are <= 0x20
      // But XML 1.1 allows non-white characters that are also < 0x20, so we
      // need a specific test for these
  ...
  private static boolean [] C0WHITE = { false,
                                        false,
                                        false,
                                        false,
                                        false,
  ...
  public static CharSequence normalizeWhitespace (final CharSequence in)
  {
  ...
  public static CharSequence collapseWhitespace (final CharSequence in)
  {
   ...
   */
  public static CharSequence trimWhitespace (final CharSequence in)
  {
    if (in.length () == 0)
    {
      return in;
