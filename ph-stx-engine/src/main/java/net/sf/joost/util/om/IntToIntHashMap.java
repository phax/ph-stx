/*
 * $Id: IntToIntHashMap.java,v 1.1 2007/06/04 19:57:35 obecker Exp $
 *
...
public class IntToIntHashMap implements Serializable
{
   ...
   */
  public IntToIntHashMap (final int capacity)
  {
    this (capacity, 0.25);
  }
   ...
   *        the load factor.
   */
  public IntToIntHashMap (final int capacity, final double factor)
  {
    _factor = factor;
   ...
   */
  public boolean find (final int key)
  {
