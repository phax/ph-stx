/*
 * $Id: CharSlice.java,v 1.1 2007/06/04 19:57:35 obecker Exp $
 *
 ...
 * existence. This class should be more efficient than String because it avoids
 * copying the characters unnecessarily. The methods in the class don't check
 * their arguments. Incorrect arguments will generally result in exceptions from
 * lower-level classes.
 */
public final class CharSlice implements CharSequence, Serializable
{
  ...
  public CharSlice (final char [] array, final int start, final int length)
  {
    this.array = array;
    this.offset = start;
    this.count = length;
  ...
  /**
   * Returns the character at the specified index. An index ranges from zero to
   * <tt>length() - 1</tt>. The first character of the sequence is at index
