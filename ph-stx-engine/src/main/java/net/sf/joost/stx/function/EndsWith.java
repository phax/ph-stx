/*
 * $Id: EndsWith.java,v 1.3 2007/05/20 18:00:44 obecker Exp $
 *
...
/**
 * The <code>ends-with</code> function.<br>
 * Returns <code>true</code> if the string in the first parameter ends with the
 * substring provided as second parameter.
 *
 * @see <a target="xq1xp2fo" href=
 *      "http://www.w3.org/TR/xpath-functions/#func-ends-with"> fn:ends-with in
 *      "XQuery 1.0 and XPath 2.0 Functions and Operators"</a>
 * @version $Revision: 1.3 $ $Date: 2007/05/20 18:00:44 $
 * @author Oliver Becker
 */
public final class EndsWith implements IInstance
{
  /** @return 2 **/
  ...
  {
    return FunctionFactory.FNSP + "ends-with";
  }
