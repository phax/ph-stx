...
/**
 * Objects of OrTree represent logical OR nodes in the syntax tree of a pattern
 * or an STXPath expression.
 * 
 * @version $Revision: 1.1 $ $Date: 2004/09/29 05:59:51 $
 * @author Oliver Becker
 */
public final class OrTree extends AbstractTree
{
  public OrTree (final AbstractTree left, final AbstractTree right)
  {
    super (OR, left, right);
  }
