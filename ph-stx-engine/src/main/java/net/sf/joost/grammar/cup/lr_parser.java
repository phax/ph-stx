...
public abstract class lr_parser
{
   ...
   */
  public void report_fatal_error (final String message, final Object info) throws java.lang.Exception
  {
  ...
  public List <Integer> expected_token_ids ()
  {
    ...
    final int parse_state = stack.peek ().parse_state;
   ...
   *        the current lookahead Symbol.
   */
  public void unrecovered_syntax_error (final Symbol cur_token) throws java.lang.Exception
  {
   ...
   */
  protected boolean error_recovery (final boolean debug) throws java.lang.Exception
  {
    if (debug)
  ...
  protected boolean find_recovery_config (final boolean debug)
  {
    ...
    final Symbol right = stack.peek ();// TUM 20060327 removed .right
   ...
   *        should we produce debugging messages as we parse.
   */
  protected boolean try_parse_ahead (final boolean debug) throws java.lang.Exception
  {
    int act;
    short lhs, rhs_size;
   ...
   *        should we produce debugging messages as we parse.
   */
  protected void parse_lookahead (final boolean debug) throws java.lang.Exception
  {
    /* the current action code */
    int act;
