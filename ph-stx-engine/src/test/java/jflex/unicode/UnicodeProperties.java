...
/**
 * This class was automatically generated by jflex-unicode-maven-plugin based on
 * data files downloaded from unicode.org.
 */
public class UnicodeProperties
{
   ...
   *
   * @param version
   *        The Unicode version for which to unpack data
   * @throws UnsupportedUnicodeVersionException
   *         if the given version is not supported.
   */
  public UnicodeProperties (final String version) throws UnsupportedUnicodeVersionException
  {
    init (version);
  }
   ...
   *
   * @param propertyValue
   *        The Unicode property or property value (or alias for one of these)
   *        for which to return the corresponding character intervals.
   * @return The character interval set corresponding to the given property
   *         value, if a match exists, and null otherwise.
   */
  public IntCharSet getIntCharSet (final String propertyValue)
  {
  ...
  /**
   * Returns a set of character intervals representing all characters that are
   * case-insensitively equivalent to the given character, including the given
   * character itself.
   * <p/>
   * The first call to this method lazily initializes the backing data.
   *
   * @param c
   *        The character for which to return case-insensitive equivalents.
   * @return All case-insensitively equivalent characters, or null if the given
   *         character is case-insensitively equivalent only to itself.
   */
  public IntCharSet getCaselessMatches (final int c)
  {
  ...
  private void initCaselessMatches ()
  {
    ...
    final int [] members = new int [caselessMatchPartitionSize];
    for (int index = 0; index < caselessMatchPartitions.length ();)
    {
      final IntCharSet partition = new IntCharSet ();
      for (int n = 0; n < caselessMatchPartitionSize; ++n)
      {
        final int c = caselessMatchPartitions.codePointAt (index);
        index += Character.charCount (c);
        members[n] = c;
        if (c > 0)
          partition.add (c); // ignore trailing zero padding
      }
   ...
   *
   * @param version
   *        The Unicode version for which to bind data
   * @throws UnsupportedUnicodeVersionException
   *         if the given version is not supported.
   */
  private void init (final String version) throws UnsupportedUnicodeVersionException
  {

    if (version.equals ("1.1") || version.equals ("1.1.5"))
    {
      bind (Unicode_1_1.propertyValues,
      ...
      if (version.equals ("2") || version.equals ("2.0") || version.equals ("2.0.14"))
      {
        bind (Unicode_2_0.propertyValues,
        ...
        if (version.equals ("2.1") || version.equals ("2.1.9"))
        {
          bind (Unicode_2_1.propertyValues,
          ...
          if (version.equals ("3") || version.equals ("3.0") || version.equals ("3.0.1"))
          {
            bind (Unicode_3_0.propertyValues,
            ...
            if (version.equals ("3.1") || version.equals ("3.1.0"))
            {
              bind (Unicode_3_1.propertyValues,
              ...
              if (version.equals ("3.2") || version.equals ("3.2.0"))
              {
                bind (Unicode_3_2.propertyValues,
                ...
                if (version.equals ("4") || version.equals ("4.0") || version.equals ("4.0.1"))
                {
                  bind (Unicode_4_0.propertyValues,
                  ...
                  if (version.equals ("4.1") || version.equals ("4.1.0"))
                  {
                    bind (Unicode_4_1.propertyValues,
                    ...
                    if (version.equals ("5") || version.equals ("5.0") || version.equals ("5.0.0"))
                    {
                      bind (Unicode_5_0.propertyValues,
                      ...
                      if (version.equals ("5.1") || version.equals ("5.1.0"))
                      {
                        bind (Unicode_5_1.propertyValues,
                        ...
                        if (version.equals ("5.2") || version.equals ("5.2.0"))
                        {
                          bind (Unicode_5_2.propertyValues,
                          ...
                          if (version.equals ("6") || version.equals ("6.0") || version.equals ("6.0.0"))
                          {
                            bind (Unicode_6_0.propertyValues,
                            ...
                            if (version.equals ("6.1") || version.equals ("6.1.0"))
                            {
                              bind (Unicode_6_1.propertyValues,
                              ...
                              if (version.equals ("6.2") || version.equals ("6.2.0"))
                              {
                                bind (Unicode_6_2.propertyValues,
                                ...
                                if (version.equals ("6.3") || version.equals ("6.3.0"))
                                {
                                  bind (Unicode_6_3.propertyValues,
                                  ...
                                  if (version.equals ("7") || version.equals ("7.0") || version.equals ("7.0.0"))
                                  {
                                    bind (Unicode_7_0.propertyValues,
   ...
   *        corresponding to them, in the given intervals, for the selected
   *        Unicode version.
   * @param intervals
   *        The packed character intervals corresponding to and in the same
   *        order as the given propertyValues, for the selected Unicode version.
   * @param propertyValueAliases
   ...
   * @param caselessMatchPartitions
   *        The packed caseless match partition data for the selected Unicode
   *        version
   * @param caselessMatchPartitionSize
   *        The partition data record length (the maximum number of elements in
   *        a caseless match partition) for the selected Unicode version.
   */
  private void bind (final String [] propertyValues,
                     final String [] intervals,
                     final String [] propertyValueAliases,
                     final int maximumCodePoint,
                     final String caselessMatchPartitions,
                     final int caselessMatchPartitionSize)
  {
    ...
    {
      final String propertyValue = propertyValues[n];
      final String propertyIntervals = intervals[n];
      final IntCharSet set = new IntCharSet ();
      for (int index = 0; index < propertyIntervals.length ();)
      {
        final int start = propertyIntervals.codePointAt (index);
        index += Character.charCount (start);
        final int end = propertyIntervals.codePointAt (index);
      ...
      {
        final String singleLetter = propertyValue.substring (0, 1);
    ...
    {
      final String alias = propertyValueAliases[n];
      final String propertyValue = propertyValueAliases[n + 1];
      final IntCharSet targetSet = propertyValueIntervals.get (propertyValue);
      if (null != targetSet)
      {
  ...
  {
    final IntCharSet asciiSet = new IntCharSet (new Interval (0, 0x7F));
    propertyValueIntervals.put (normalize ("ASCII"), asciiSet);

    final IntCharSet anySet = new IntCharSet (new Interval (0, maximumCodePoint));
  ...
  private String normalize (final String identifier)
  {
    if (null == identifier)
      return identifier;
    final Matcher matcher = WORD_SEP_PATTERN.matcher (identifier.toLowerCase (Locale.ENGLISH));
