...
/**
 * Central class for all kinds of JFlex messages. [Is not yet used exclusively,
 * but should]
 *
 * @author Gerwin Klein
 * @version JFlex 1.6.1
...
public class ErrorMessages
{
  ...
  /*
   * not final static, because initializing here seems too early for OS/2 JDK
   * 1.1.8. See bug 1065521.
   */
  private static ResourceBundle resourceBundle = null;

  private ErrorMessages (final String key)
  {
    this.key = key;
  }

  public static String get (final ErrorMessages msg)
  {
  ...
  public static String get (final ErrorMessages msg, final String data)
  {
    final Object [] args = { data };
    return MessageFormat.format (get (msg), args);
  }

  public static String get (final ErrorMessages msg, final String data1, final String data2)
  {
    final Object [] args = { data1, data2 };
    return MessageFormat.format (get (msg), args);
  }

  public static String get (final ErrorMessages msg, final int data)
  {
    final Object [] args = { data };
    return MessageFormat.format (get (msg), args);
  }
