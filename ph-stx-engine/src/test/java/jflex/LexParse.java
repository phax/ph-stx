...
public class LexParse extends java_cup.runtime.lr_parser
{
  ...
  public LexParse (final java_cup.runtime.Scanner s)
  {
    super (s);
  }

  /** Constructor which sets the default scanner. */
  public LexParse (final java_cup.runtime.Scanner s, final java_cup.runtime.SymbolFactory sf)
  {
    super (s, sf);
  }
  ...
  /** Parse-action table. */
  protected static final short [] [] _action_table = unpackFromStrings (new String [] { "\000\304\000\006\002\uffff\052\004\001\002\000\016\003" +
  ...
  protected static final short [] [] _reduce_table = unpackFromStrings (new String [] { "\000\304\000\004\005\004\001\001\000\004\002\007\001" +
  ...
  public void user_init () throws java.lang.Exception
  {
    ...
    // CharClasses.init() is delayed until UnicodeProperties.init() has been
    // called,
  ...
  public LexParse (final LexScan scanner)
  {
    super (scanner);
...
class CUP$LexParse$actions
{
  ...
  void fatalError (final ErrorMessages message)
  {
    fatalError (message, scanner.currentLine (), -1);
    throw new GeneratorException ();
  }

  void syntaxError (final ErrorMessages message)
  {
    Out.error (scanner.file, message, scanner.currentLine (), -1);
  }

  void syntaxError (final ErrorMessages message, final int line)
  {
    Out.error (scanner.file, message, line, -1);
  }

  void syntaxError (final ErrorMessages message, final int line, final int col)
  {
    Out.error (scanner.file, message, line, col);
  }

  void warning (final ErrorMessages message, final int line, final int col)
  {
    Out.warning (scanner.file, message, line, col);
  }

  private boolean isDotOrNewlinePattern (final RegExp r1, final RegExp r2)
  {
    return (r1 instanceof RegExp1 && ((RegExp1) r1).isPoint && isNewline (r2)) ||
           (r2 instanceof RegExp1 && ((RegExp1) r2).isPoint && isNewline (r1));
  }

  private boolean isNewline (final RegExp r)
  {
    if (!(r instanceof RegExp1) || null == ((RegExp1) r).content)
    {
      return false;
    }
    final RegExp1 r1 = (RegExp1) r;
    switch (r1.type)
    {
      case sym.STRING:
      case sym.STRING_I:
      ...
      case sym.CCLASS:
        final List <Interval> intervals = (List <Interval>) r1.content;
        if (1 == intervals.size ())
        {
          final Interval i = intervals.get (0);
          return '\n' == i.start && '\n' == i.end;
        }
        return false;
      default:
  ...
  private boolean check (final int type, final int c)
  {
    switch (type)
    {
  ...
  private List <Interval> getPreClass (final int type)
  {
    ...
    {
      final UnicodeProperties unicodeProperties = scanner.getUnicodeProperties ();
      switch (type)
      {
        ...
        {
          final IntCharSet digits = unicodeProperties.getIntCharSet ("Nd");
        ...
        case sym.WORDCLASS:
        {
          ...
          final IntCharSet markClass = unicodeProperties.getIntCharSet ("M");
          final IntCharSet digitClass = unicodeProperties.getIntCharSet ("Nd");
        ...
        case sym.WORDCLASSNOT:
        {
          ...
          final IntCharSet wordClass = alphaClass.copy ();
        ...
        default:
        {
          ...
          int c = 0;
          int start = 0;
          final int last = charClasses.getMaxCharCode ();
  ...
  private RegExp makeRepeat (final RegExp r, int n1, int n2, final int line, final int col)
  {
    ...
    if (n1 > 0)
    {
      result = r;
      n1--;
      n2--; // we need one concatenation less than the number of expressions to
            // match
    }
    else
    {
  ...
  private RegExp makeNL ()
  {
    ...
    final RegExp1 c = new RegExp1 (sym.CCLASS, list);
    final Integer n = new Integer ('\n');
    final Integer r = new Integer ('\r');

    return new RegExp2 (sym.BAR, c, new RegExp2 (sym.CONCAT, new RegExp1 (sym.CHAR, r), new RegExp1 (sym.CHAR, n)));
  }

  private final LexParse parser;

  /** Constructor */
  CUP$LexParse$actions (final LexParse parser)
  {
    this.parser = parser;
  }

  /** Method with the actual generated action code. */
  public final java_cup.runtime.Symbol CUP$LexParse$do_action (final int CUP$LexParse$act_num,
                                                               final java_cup.runtime.lr_parser CUP$LexParse$parser,
                                                               final java.util.Stack CUP$LexParse$stack,
                                                               final int CUP$LexParse$top) throws java.lang.Exception
  {
    ...
    switch (CUP$LexParse$act_num)
    {
      ...
      case 112: // preclass ::= WORDCLASSNOT
      {
        ...
        CUP$LexParse$result = parser.getSymbolFactory ().newSymbol ("preclass",
                                                                    12,
      ...
      case 100: // classcontentelem ::= CHAR DASH CHAR
      {
        ...
        CUP$LexParse$result = parser.getSymbolFactory ().newSymbol ("classcontentelem",
                                                                    10,
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top -
                                                                                                                             2)),
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
                                                                    RESULT);
      }
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 85: // charclass ::= OPENCLASS HAT DASH classcontent
               // SYMMETRICDIFFERENCE DASH classcontent CLOSECLASS
      {
        ...
        final IntCharSet union = intcharset1.copy ();
        union.add (intcharset2);
        final IntCharSet intersection = intcharset1.and (intcharset2);
        union.sub (intersection);
        final List <Interval> intervals = union.getIntervals ();
        charClasses.makeClassNot (intervals, Options.jlex && scanner.caseless);
        RESULT = new RegExp1 (sym.CCLASSNOT, intervals);

        CUP$LexParse$result = parser.getSymbolFactory ().newSymbol ("charclass",
                                                                    8,
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top -
                                                                                                                             7)),
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 84: // charclass ::= OPENCLASS HAT classcontent SYMMETRICDIFFERENCE
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 83: // charclass ::= OPENCLASS HAT DASH classcontent
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 82: // charclass ::= OPENCLASS HAT classcontent SYMMETRICDIFFERENCE
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 81: // charclass ::= OPENCLASS DASH classcontent SYMMETRICDIFFERENCE
               // DASH classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 80: // charclass ::= OPENCLASS classcontent SYMMETRICDIFFERENCE DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 79: // charclass ::= OPENCLASS DASH classcontent SYMMETRICDIFFERENCE
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 78: // charclass ::= OPENCLASS classcontent SYMMETRICDIFFERENCE
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 77: // charclass ::= OPENCLASS HAT DASH classcontent DIFFERENCE DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
        ...
        list2.add (new Interval ('-', '-'));
        final IntCharSet intcharset2 = new IntCharSet (list2);
        // IntCharSet.sub() assumes its argument is a subset, so subtract
        // intersection
        final IntCharSet intersection = intcharset1.and (intcharset2);
        intcharset1.sub (intersection);
        final List <Interval> intervals = intcharset1.getIntervals ();
        charClasses.makeClassNot (intervals, Options.jlex && scanner.caseless);
        RESULT = new RegExp1 (sym.CCLASSNOT, intervals);
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 76: // charclass ::= OPENCLASS HAT classcontent DIFFERENCE DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 75: // charclass ::= OPENCLASS HAT DASH classcontent DIFFERENCE
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 74: // charclass ::= OPENCLASS HAT classcontent DIFFERENCE
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 73: // charclass ::= OPENCLASS DASH classcontent DIFFERENCE DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 72: // charclass ::= OPENCLASS classcontent DIFFERENCE DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 71: // charclass ::= OPENCLASS DASH classcontent DIFFERENCE
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 70: // charclass ::= OPENCLASS classcontent DIFFERENCE classcontent
               // CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 69: // charclass ::= OPENCLASS HAT DASH classcontent INTERSECTION
               // DASH classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
        ...
        final IntCharSet intcharset2 = new IntCharSet (list2);
        final IntCharSet intersection = intcharset1.and (intcharset2);
        final List <Interval> intervals = intersection.getIntervals ();
        charClasses.makeClassNot (intervals, Options.jlex && scanner.caseless);
        RESULT = new RegExp1 (sym.CCLASSNOT, intervals);
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 68: // charclass ::= OPENCLASS HAT classcontent INTERSECTION DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 67: // charclass ::= OPENCLASS HAT DASH classcontent INTERSECTION
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 66: // charclass ::= OPENCLASS HAT classcontent INTERSECTION
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 65: // charclass ::= OPENCLASS DASH classcontent INTERSECTION DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
        ...
        list2.add (new Interval ('-', '-'));
        final IntCharSet intcharset2 = new IntCharSet (list2);
        final List <Interval> intervals = intcharset1.and (intcharset2).getIntervals ();
        charClasses.makeClass (intervals, Options.jlex && scanner.caseless);
        RESULT = new RegExp1 (sym.CCLASS, intervals);
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 64: // charclass ::= OPENCLASS classcontent INTERSECTION DASH
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 4)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 63: // charclass ::= OPENCLASS DASH classcontent INTERSECTION
               // classcontent CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      /* . . . . . . . . . . . . . . . . . . . . */
      case 62: // charclass ::= OPENCLASS classcontent INTERSECTION classcontent
               // CLOSECLASS
      {
        RegExp RESULT = null;
        final int list1left = ((java_cup.runtime.Symbol) CUP$LexParse$stack.elementAt (CUP$LexParse$top - 3)).left;
      ...
      case 61: // charclass ::= OPENCLASS HAT DASH classcontent CLOSECLASS
      {
        ...
        catch (final CharClassException e)
        {
      ...
      case 53: // regexp ::= POINT
      {
        ...
        final RegExp1 r = new RegExp1 (sym.CCLASSNOT, any);
        r.isPoint = true;
        RESULT = r;
      ...
      case 47: // regexp ::= MACROUSE
      {
        ...
        if (!scanner.macroDefinition)
        {
          if (!macros.markUsed (ident))
            throw new ScannerException (scanner.file, ErrorMessages.MACRO_UNDECL, identleft, identright);
        }
      ...
      case 32: // hatOPT ::=
      {
        Boolean RESULT = null;
        RESULT = false;
        CUP$LexParse$result = parser.getSymbolFactory ().newSymbol ("hatOPT",
                                                                    16,
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
                                                                    RESULT);
      ...
      case 5: // macros ::= error
      {
        ...
        CUP$LexParse$result = parser.getSymbolFactory ().newSymbol ("macros",
                                                                    0,
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
                                                                    RESULT);
      ...
      {
        final NFA RESULT = null;

        fatalError (ErrorMessages.NO_LEX_SPEC);

        CUP$LexParse$result = parser.getSymbolFactory ().newSymbol ("specification",
                                                                    3,
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
                                                                    ((java_cup.runtime.Symbol) CUP$LexParse$stack.peek ()),
                                                                    RESULT);
      ...
      case 1: // specification ::= USERCODE macros DELIMITER rules
      {
        ...
        {
          for (final String unusedMacro : macros.unused ())
          {
            Out.warning (String.format ("Macro \"%s\" has been declared but never used.", unusedMacro));
          }
        }
