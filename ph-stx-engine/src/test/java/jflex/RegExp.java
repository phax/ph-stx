...
/**
 * Stores a regular expression of rules section in a JFlex-specification. This
 * base class has no content other than its type.
 *
 * @author Gerwin Klein
 * @version JFlex 1.6.1
 */
public class RegExp
{
  ...
  /**
   * The type of the regular expression. This field will be filled with values
   * from class sym.java (generated by cup)
   */
  int type;
  ...
  /**
   * The approximate number of NFA states this expression will need (only works
   * correctly after macro expansion and without negation)
   *
   * @param macros
   *        macro table for expansion
   */
  public int size (final Macros macros)
  {
    RegExp1 unary;
    RegExp2 binary;
    RegExp content;
   ...
   */
  public final static String revString (final String s)
  {
    final StringBuffer b = new StringBuffer (s.length ());
    for (int i = s.length (); i > 0;)
    {
      final int ch = s.codePointBefore (i);
   ...
   * @return new RegExp equivalent to the current one, but without upto
   *         expressions.
   */
  public final RegExp resolveTilde (final Macros macros)
  {
    RegExp1 unary;
    RegExp2 binary;
    RegExp content;
    ...
    switch (type)
    {
      ...
      case sym.TILDE:
        ...
        final RegExp any_star = new RegExp1 (sym.STAR, anyChar ());
        final RegExp neg = new RegExp1 (sym.BANG,
   ...
   */
  public final RegExp rev (final Macros macros)
  {
    RegExp1 unary;
    RegExp2 binary;
    RegExp content;
