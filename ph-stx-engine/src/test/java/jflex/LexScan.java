 ...
 * <tt>/Users/kleing/src/jflex-git/jflex/src/main/jflex/LexScan.flex</tt>
 */
public final class LexScan implements sym, java_cup.runtime.Scanner
{
   ...
   */
  private static final int ZZ_LEXSTATE[] = { 0,
                                             0,
                                             1,
                                             1,
                                             2,
   ...
   */
  private static final String ZZ_CMAP_PACKED = "\10\26\1\27\1\11\1\14\1\12\1\12\1\13\16\26\4\0\1\11" +
  ...
  private static final String ZZ_ACTION_PACKED_0 = "\23\0\4\1\1\2\3\3\1\4\1\5\2\6\1\5" +
  ...
  private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\117\0\236\0\355\0\u013c\0\u018b\0\u01da\0\u0229" +
  ...
  private static final String ZZ_TRANS_PACKED_0 = "\12\24\1\25\1\26\1\25\13\24\1\25\6\24\1\27" +
  ...
  {
    final int [] result = new int [52693];
    int offset = 0;
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 = "\23\0\1\1\1\11\5\1\1\11\2\1\1\11\13\1" +
  ...
  private final java.util.Stack <ZzFlexStreamInfo> zzStreams = new java.util.Stack<> ();
  ...
  private static final class ZzFlexStreamInfo
  {
    ...
    ZzFlexStreamInfo (final java.io.Reader zzReader,
                      final int zzEndRead,
                      final int zzStartRead,
                      final int zzCurrentPos,
                      final int zzMarkedPos,
                      final char [] zzBuffer,
                      final boolean zzAtBOL,
                      final boolean zzAtEOF,
                      final boolean zzEOFDone,
                      final int zzFinalHighSurrogate,
                      final int yyline,
                      final int yychar,
                      final int yycolumn)
    {
  ...
  // untouched
  private Symbol symbol_countUpdate (final int type, final Object value)
  {
    int lc = yyline;
    int cc = yycolumn;
  ...
  {
    final String matched = yytext ().trim ();
    return matched.substring (1, matched.length () - 1).trim ();
  }

  public static String conc (final Object a, final Object b)
  {
    if (a == null && b == null)
      return null;
    if (a == null)
  ...
  public static String concExc (final Object a, final Object b)
  {
    if (a == null && b == null)
      return null;
    if (a == null)
  ...
  private void includeFile (final String filePath)
  {
    final File f = new File (file.getParentFile (), filePath);
    if (!f.canRead ())
   ...
   */
  public LexScan (final java.io.Reader in)
  {
   ...
   * current input stream can be restored with yypopStream (usually in an
   * <<EOF>> action).
   *
   * @param reader
   ...
   * @see #yypopStream()
   */
  public final void yypushStream (final java.io.Reader reader)
  {
    zzStreams.push (new ZzFlexStreamInfo (zzReader,
                                          zzEndRead,
                                          zzStartRead,
                                          zzCurrentPos,
                                          zzMarkedPos,
  ...
  {
    zzReader.close ();
    final ZzFlexStreamInfo s = zzStreams.pop ();
    zzBuffer = s.zzBuffer;
    zzReader = s.zzReader;
    ...
    while (true)
    {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction])
      {
        ...
        case 31:
        {
          ...
          {
            yybegin (REGEXPSTART);
            final Action a = new Action (actionText.toString (), action_line);
            actions.add (a);
        ...
        case 49:
        {
          final int codePoint = Integer.parseInt (yytext (), 16);
        ...
        case 92:
        {
          final int codePoint = Integer.parseInt (yytext ().substring (0, yylength () - 1), 16);
          if (codePoint <= unicodeProperties.getMaximumCodePoint ())
          {
            yybegin (CHARCLASS);
        ...
        case 106:
        {
          final String trimmedText = yytext ().trim ();
          final String propertyValue = trimmedText.substring (3, trimmedText.length () - 1);
          final IntCharSet set = unicodeProperties.getIntCharSet (propertyValue);
          if (null == set)
          {
        ...
        case 126:
        {
          final String v = yytext ().substring (8).trim ();
          if (v.length () == 0)
          {
            populateDefaultVersionUnicodeProperties ();
          }
        ...
        case 134:
        {
          final int codePoint = Integer.parseInt (yytext ().substring (2, yylength ()), 16);
          if (codePoint <= unicodeProperties.getMaximumCodePoint ())
          {
            return symbol (CHAR, codePoint);
          }
  ...
  private String getTokenName (final int token)
  {
    try
    {
      final java.lang.reflect.Field [] classFields = sym.class.getFields ();
  ...
  public static void main (final String argv[])
  {
    ...
    else
    {
      ...
      if (argv[0].equals ("--encoding"))
      {
        ...
        try
        {
          java.nio.charset.Charset.forName (encodingName); // Side-effect: is
                                                           // encodingName
                                                           // valid?
        }
        catch (final Exception e)
      ...
      for (int i = firstFilePos; i < argv.length; i++)
      {
        ...
        try
        {
          final java.io.FileInputStream stream = new java.io.FileInputStream (argv[i]);
          final java.io.Reader reader = new java.io.InputStreamReader (stream, encodingName);
