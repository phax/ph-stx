...
public class non_terminal extends symbol
{
  ...
  public non_terminal (final String nm, final String tp)
  {
    ...
    if (conflict != null)
                         // can't throw an exception here because these are used
                         // in static
                         // initializers, so we crash instead
                         // was:
                         // throw new internal_error("Duplicate non-terminal
                         // ("+nm+") created");
   ...
   */
  static non_terminal create_new (final String prefix) throws internal_error
  {
   ...
   */
  static non_terminal create_new (String prefix, final String type) throws internal_error
  {
    if (prefix == null)
      prefix = "NT$";
