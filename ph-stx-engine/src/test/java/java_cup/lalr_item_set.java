...
public class lalr_item_set
{
   ...
   */
  public boolean is_subset_of (final lalr_item_set other) throws internal_error
  {
    not_null (other);

    /* walk down our set and make sure every element is in the other */
    for (final Enumeration e = all (); e.hasMoreElements ();)
   ...
   *        the other set in question.
   */
  public boolean is_superset_of (final lalr_item_set other) throws internal_error
  {
    not_null (other);
