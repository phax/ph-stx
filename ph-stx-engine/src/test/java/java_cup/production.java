...
public class production
{
   ...
   * parser.
   */
  public production (final non_terminal lhs_sym,
   ...
   * @author frankf
   */
  protected String make_declaration (final String labelname, final String stack_type, final int offset)
  {
    String ret;
   ...
   */
  protected String declare_labels (final production_part rhs[], final int rhs_len, final String final_action)
  {
    String declaration = "";
   ...
   */
  protected int merge_adjacent_actions (final production_part rhs_parts[], final int len)
  {
   ...
   */
  protected action_part strip_trailing_action (final production_part rhs_parts[], final int len)
  {
    action_part result;
  ...
  ) throws internal_error
  {
    ...
    for (int act_loc = 0; act_loc < rhs_length (); act_loc++)
      if (rhs (act_loc).is_action ())
      {
        ...
        new_nt = non_terminal.create_new (null, lhs ().the_symbol ().stack_type ()); // TUM
                                                                                     // 20060608
                                                                                     // embedded
                                                                                     // actions
                                                                                     // patch
        ...
        new_prod = new action_production (this,
                                          new_nt,
                                          null,
                                          0,
