...
public class lalr_item extends lr_item_core
{
   ...
   */
  public lalr_item (final production prod, final int pos, final terminal_set look) throws internal_error
  {
    super (prod, pos);
    _lookahead = look;
   ...
   *        the set of lookahead symbols.
   */
  public lalr_item (final production prod, final terminal_set look) throws internal_error
  {
    this (prod, 0, look);
  }
   ...
   */
  public void propagate_lookaheads (final terminal_set incoming) throws internal_error
  {
   ...
   * terminals.
   */
  public terminal_set calc_lookahead (final terminal_set lookahead_after) throws internal_error
  {
    terminal_set result;
    int pos;
